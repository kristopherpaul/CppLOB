...
using InitialBook = Book<BidBook<PriceLevel<100, Order<Side::Buy, 100, 10, 1>>, PriceLevel<99, Order<Side::Buy, 99, 10, 101>>>, AskBook<PriceLevel<101, Order<Side::Sell, 101, 10, 1001>>, PriceLevel<102, Order<Side::Sell, 102, 10, 1101>>>>;
